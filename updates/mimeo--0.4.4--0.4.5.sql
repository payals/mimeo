...
ALTER TABLE @extschema@.refresh_config ADD COLUMN period interval DEFAULT NULL;
ALTER TABLE @extschema@.refresh_config ADD COLUMN batch_limit int DEFAULT 10000;
